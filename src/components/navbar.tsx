...
import { User as LucideUser, UserCircle, ShoppingCart, Menu, Search, Heart, ChevronDown } from "lucide-react";
  ...
  return (
    <header className="w-full border-b border-gray-100 bg-white sticky top-0 z-50">
      ...
      <nav className="py-4">
        <div className="container mx-auto px-4 flex justify-between items-center">
          {/* Logo */}
          <Link href="/" prefetch className="text-2xl font-bold text-[#E2BA45]">
            Butter & Magic
          </Link>
